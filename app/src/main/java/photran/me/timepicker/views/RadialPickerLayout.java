...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    public void setCurrentItemShowing(int index, boolean animate) {
        ...
        if (animate && (index != lastIndex)) {
            ...
            mHourRadialTextsView.setAlpha(hourAlpha / 255.0f);
            mHourRadialSelectorView.setAlpha(hourAlpha / 255.0f);
            mMinuteRadialTextsView.setAlpha(minuteAlpha / 255.0f);
            mMinuteRadialSelectorView.setAlpha(minuteAlpha / 255.0f);
        }
